...
export class LivestreamResolver {
    ...
    livestream_tasks(
        @Arg('filters', type => LivestreamQueryFilters, { nullable: true }) filters: LivestreamQueryFilters,
    ...
    create_livestream(
        @Arg('task', type => LivestreamInput) task: LivestreamInput,
    ) {
    ...
    update_livestream(
        @Arg('task', type => LivestreamUpdateInput) task: LivestreamUpdateInput
    ) {
