...
export class BuffViewersLivestreamResolver {
    ...
    buff_viewers_livestream_tasks(
        @Arg('filters', type => BuffViewersLivestreamQueryFilters, { nullable: true }) filters: BuffViewersLivestreamQueryFilters,
    ...
    @Mutation(type => BuffViewersLivestreamTaskCUDResponse)
    delete_buff_viewers_livestream_task(
        @Arg('id', type => ID) id: string
    ) {
