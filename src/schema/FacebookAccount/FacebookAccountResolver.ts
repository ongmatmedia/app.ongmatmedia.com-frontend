...
export class FacebookAccountResolver {
  ...
  facebook_accounts(
    @Arg('filter', type => FacebookAccountQueryFilters, { nullable: true }) filter: FacebookAccountQueryFilters,
  ...
  add_facebook_account(
    @Arg("input", type => FacebookAccountInput) id: FacebookAccountInput,
  ) { }
