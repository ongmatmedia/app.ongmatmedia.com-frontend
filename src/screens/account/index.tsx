    ...
    <Row style={{ backgroundColor: "white", padding: 20 }}>
      <Col span={24}>
        <Tabs activeKey={activeTabKey} onTabClick={(key: string, event: MouseEvent) => setActiveTabKey(key)} defaultActiveKey="1" type="card">
          ...
          <TabPane tab="Shopee" key="2" disabled>
          </TabPane>
          <TabPane tab="Zalo" key="3" disabled>
          </TabPane>
          <TabPane tab="Sendo" key="4" disabled>
          </TabPane>
          <TabPane tab="Lazada" key="5" disabled>
          </TabPane>
          <TabPane tab="Tiki" key="6" disabled>
          </TabPane>
        </Tabs>
      </Col>
    </Row>
