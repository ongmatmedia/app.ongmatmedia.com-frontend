...
export const FacebookLoginTab = Form.create<FacebookLoginTabProps>()((props: FacebookLoginTabProps) => {
  ...
  return (
    <Spin spinning={loading}>
      <Form layout="vertical" onSubmit={handleSubmit}>
        ...
        <Form.Item label="App Password" extra="Just use app password for preventing checkpoint. Be carefully!">
          {form.getFieldDecorator('app_password', {
            rules: [
              {
                required: true,
                message:
                  'Please input your app password!',
              },
            ],
            initialValue: '',
