...
const SetNewPasswordPageView = withRouter<any, any>((props: RouterProps & FormComponentProps) => {
  const data = JSON.parse(localStorage.getItem('tmp-user-credential') as string);
