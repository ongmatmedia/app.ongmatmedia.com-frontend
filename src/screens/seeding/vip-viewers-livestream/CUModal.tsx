...
import { FacebookAccountInput } from '../../../components/FacebookAccountInput'
...
export const CUModal = GraphQLWrapper<CUModalGraphqlData, CUModalProps>(
	...
	withForm(props => {
				...
				content: (
					<RefundOrderInfo
						...
						statics={[
							...
							{
								name: 'Price',
								amount: props.data.me.pricing?.vip_viewers_livestream || 0,
							},
							{
								name: 'Refund',
								color: 'red',
								amount:
									props.vip.amount *
									props.vip.bought_mins *
									(props.data.me.pricing?.vip_viewers_livestream || 0),
							},
						]}
					/>
				),
		...
		const amounts_list = new Array(50)
			.fill(0)
				...
				<Spin spinning={props.loading}>
						...
						render: _ => (
							...
							>
								<FacebookAccountInput
									account={
										_.value
											? { id: _.value, name: props.vip?.name || '' }
											: undefined
									}
					...
					{props.vip && (
						<Row type="flex" justify="end">
							<Col>
								<Button icon="delete" type="danger" onClick={onCancel}>
									Delete then refund
								</Button>
							</Col>
						</Row>
