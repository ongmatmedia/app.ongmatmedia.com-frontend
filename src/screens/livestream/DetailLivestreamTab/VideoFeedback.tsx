		...
		<Row>
			...
			{new Array(10).fill(
				<Button style={{ marginRight: 5, marginBottom: 5 }}>
					<Avatar
						src="https://lh3.googleusercontent.com/proxy/OFd0E4rwA6Zze4NyOzwoeBWCSARW_gF7uTgJQ-FYNXisA7h2uQHkRfKZHGva2yRsxh7Val0cpKwIa5MTAh__bLmyunUX1ZAkPfslaMw0r1z4gy6TD3L0"
						size="small"
