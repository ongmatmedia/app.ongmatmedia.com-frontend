...
export const FriendsFilteringTable = withFilterFriendsStore(props => {
	const columns: ColumnProps<Friend>[] = [
		...
		},
		{
			...
			key: 'friend_count',
			render: (d: Friend) =>
				d.friend_count && <Tag color="blue">{d.friend_count}</Tag>,
		...
		},
		{
			...
			key: 'reactions',
			render: (d: Friend) =>
				d.reactions > 0 && <Tag color="purple">{d.reactions}</Tag>,
		...
		},
		{
			...
			key: 'comment',
			render: (d: Friend) =>
				d.comment > 0 && <Tag color="#2db7f5">{d.comment}</Tag>,
		...
		},
		{
			...
			key: 'inbox',
			render: (d: Friend) =>
				d.inbox > 0 && <Tag color="#108ee9">{d.inbox}</Tag>,
