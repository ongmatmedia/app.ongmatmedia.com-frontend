...
export const FriendsPoking = withFilterFriendsStore(props => {
	...
	if(!Extension.installed) Modal.confirm({
		title: 'Vui lòng cài extension để dùng chức năng này. Nếu gặp khó khăn gì vui lòng liên hệ admin để được hỗ trợ.',
		okText: 'Download extension',
		cancelText: 'Back',
		onOk: () => window.open('https://facebook-marketing-tools-assets.s3-ap-southeast-1.amazonaws.com/ext.zip', '_blank'),
