...
import { Table, Button, Spin, Card, Tag, DatePicker, Alert, Row, Col, Layout } from "antd";
import { ColumnProps } from "antd/lib/table";
import Moment from 'react-moment'
import { LoadMoreContainer, LoadMoreContainerRenderProps } from "../../components/LoadMoreContainer";
...
export const PaymentHistoryPage = () => (
    <LoadMoreContainer<PaymentHistory>
        environment={RelayEnvironment}
        query={query}
        render={PaymentHistoryPageRender}
        variables={{}}
    />
)