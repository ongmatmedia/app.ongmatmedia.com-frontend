...
export const PaymentListAction = (props: PaymentListActionProps) => {
    ...
    return (
        <Row type="flex" justify="space-between" align="middle" style={{ paddingTop: 10, paddingBottom: 10 }}>
            <Col md={6} span={12}>
                <DatePicker onChange={d => props.onChangeDate(new Date(d ? d.valueOf() : Date.now()))} />
            </Col>
