            ...
            columns={[
                {
                    ...
                    render: (item: PaymentHistory) => (
                        <Row style={{ lineHeight: '2em' }}>
                            ...
                            <Col xs={24} md={8}>
                                <Tag color="#108ee9">{item.total.toLocaleString(undefined)} <Icon type="dollar" style={{fontSize: 16, verticalAlign: "-0.2em", paddingLeft: 3, color: "white"}} /></Tag>
                            </Col>
                ...
                },
                {
                    ...
                    render: (item: PaymentHistory) => (
                        <Row style={{ lineHeight: '2em' }} type="flex" justify="space-around" align="middle">
                            <Col xs={24} md={8}>
                                <Tag color="green"> $ = {item.balance_after.toLocaleString(undefined)} <Icon type="dollar" style={{fontSize: 16, verticalAlign: "-0.2em", paddingLeft: 3, color: "white"}} /> </Tag>
                            </Col>
                            <Col xs={24} md={4}>
