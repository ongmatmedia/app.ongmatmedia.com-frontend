...
export type LivestreamSubscription = {
	user_id: Scalars['ID']
	quality: Scalars['Int']
	livestream_nums: Scalars['Int']
	livestream_used_nums: Scalars['Int']
	name: Scalars['String']
}
...
export type QueryProfile_InfoArgs = {
	url: Scalars['String']
}
...
export type ServicePricing = {
	buff_viewers_livestream: Scalars['Float']
	vip_viewers_livestream: Scalars['Float']
...
export type Subscription = {
	on_update_buff_viewers_livestream_playing?: Maybe<
