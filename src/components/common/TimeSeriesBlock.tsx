...
const data: PaymentHistory[] = [
  ...
  },
  {
    ...
    receiver_id: '1123456789',
    balance_after: 10000000,
    note: 'Buff 50 viewers livestream for 346370772515583 video id 325135155113931 with price 3$/view'
  },
  {
    id: "111111111",
    time: 987654321,
      ...
      renderItem={item => (
        <>
          ...
          <List
            ...
            renderItem={payment => (
              <List.Item style={{ borderRadius: 15, boxShadow: '0 2px 5px 0 rgba(0, 0, 0, 0.2), 0 6px 5px 0 rgba(0, 0, 0, 0.05)' }}>
                <Card
                  extra={
                    <Text strong>
                      {`${payment.total >= 0 ? '+' : ''}` + payment.total.toLocaleString()}
                    </Text>
                  }
                  type="inner">
                  <Row>
                    ...
                    <Col xs={24} style={{ marginBottom: 25 }}>
                      <Row>
                        ...
                        <Col span={12} style={{ textAlign: 'right' }}>
                          <Tag style={{ marginRight: 0, marginBottom: 2 }}>{payment.sender_username}</Tag>
                        </Col>
                        <Col span={12}>
                          <Text strong>
                            To
                        ...
                        <Col span={12} style={{ textAlign: 'right' }}>
                          <Tag style={{ marginRight: 0 }}>{payment.receiver_username}</Tag>
                        </Col>
                      </Row>
                    </Col>
                    <Col xs={24}>
