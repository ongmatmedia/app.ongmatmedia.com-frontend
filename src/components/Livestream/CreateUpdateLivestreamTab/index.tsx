import { Alert, Button, Col, Divider, Form, Input, InputNumber, notification, Row, Spin } from 'antd';
...
export const CreateUpdateLivestreamTab = Form.create<CreateUpdateLivestreamTabProps>()(
