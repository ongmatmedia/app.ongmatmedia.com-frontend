  ...
  <>
    {
      props.videosInfo.map((v, i) => (
        <Row key={i} type="flex" gutter={24} justify="space-between" align="middle" style={{ padding: 10 }}>
          <Col xs={10}>
            {' '}
          ...
          <Col xs={2}>
            <Icon
              ...
              onClick={() => {
                props.onChange([...props.videosInfo.filter(v => props.videosInfo.indexOf(v) !== i)])
              }}
            />
          </Col>
        </Row>
