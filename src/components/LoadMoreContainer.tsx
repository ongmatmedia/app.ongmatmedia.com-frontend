...
export class LoadMoreContainer<T> extends Component<
  LoadMoreContainerProps<T>,
  ...
  render() {
    return (
      <QueryRenderer
        ...
        render={rs => {
          if (rs.props) {
            const new_data = (rs.props as any)[
              Object.keys(rs.props as any)[0]
            ] as GraphQLConnection<T>;
            this.data = {
